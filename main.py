...
def read_about():
    return {
        "overall": "当サークルは、楽曲制作から音響機材の自作、イベント運営まで『音』に関する全てを突き詰める音楽集団です！",
...
def read_schedule():
    return [
        ...
        {"date": "2026年 11月", "title": "大学祭（メインステージPA＆ブース展示）", "description": "学祭のメインステージの音響（PA）をサークルで完全ジャック。DTM班のCD販売や自作スピーカー展示も行います！"},
        {"date": "2026年 12月", "title": "同人即売会「M3」出展", "description": "音系メディアミックス同人即売会「M3」にサークル出展。部員が作ったコンピレーションアルバムを一般販売します！"}
    ]
